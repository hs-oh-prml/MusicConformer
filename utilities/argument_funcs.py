...
def parse_train_args():
    ...
    parser.add_argument("-input_dir", type=str, default="./data", help="Folder of preprocessed and pickled midi files")
    parser.add_argument("-output_dir", type=str, default="./saved_models/1114", help="Folder to save model weights. Saves one every epoch")
...
def parse_eval_args():
    ...
    parser.add_argument("-dataset_dir", type=str, default="./data", help="Folder of preprocessed and pickled midi files")
    parser.add_argument("-model_weights", type=str, default="./saved_models/1114/model.pickle", help="Pickled model weights file saved with torch.save and model.state_dict()")
    parser.add_argument("-n_workers", type=int, default=1, help="Number of threads for the dataloader")
    parser.add_argument("--force_cpu", action="store_true", help="Forces model to run on a cpu even when gpu is available")
...
def parse_generate_args():
    ...
    parser.add_argument("-midi_root", type=str, default="./data", help="Midi file to prime the generator with")
    ...
    # parser.add_argument("-model_weights", type=str, default="./saved_models/1105/weights/epoch_0300.pickle", help="Pickled model weights file saved with torch.save and model.state_dict()")
    parser.add_argument("-model_weights", type=str, default="./saved_models/1114/weights/epoch_0300.pickle", help="Pickled model weights file saved with torch.save and model.state_dict()")
